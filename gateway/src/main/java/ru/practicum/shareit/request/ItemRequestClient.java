...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> getRequested(Long requesterId) {
        return get("", requesterId);
    }

    public ResponseEntity<Object> listAllRequestsItemsWithRequesterId(Long requesterId, int from, int size) {
